...
from app.crud.crud import create_department, get_department, get_departments, update_department, delete_department

class DepartmentController:
    def create_department(self, department, db, tenant_id):
        return create_department(db, department, tenant_id)

    def get_department(self, department_id, db, tenant_id):
        return get_department(db, department_id, tenant_id)
